...
foreach ($Computer in $Computers)
    ...
    $uscope = New-PSWSUSUpdateScope -ApprovedStates LatestRevisionApproved
...
$body = $output |Select-Object Group,ComputerName,IPAddress,InstalledCount,NotInstalledCount,InstalledPendingReboot,Downloaded,FailedCount,UnknownCount,NeededCount,LastUpdated,LastSyncTime,LastReportedStatusTime,OS | Export-Csv .\ComputerStatus.csv
