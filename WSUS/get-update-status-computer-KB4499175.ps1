...
foreach ($Computer in $Computers)
    ...
    $uscope = New-PSWSUSUpdateScope -ApprovedStates LatestRevisionApproved -TextIncludes "KB4499175"
...
$body = $output |Select-Object Group,ComputerName,IPAddress,OS,InstalledCount,NotInstalledCount,InstalledPendingReboot,Downloaded,FailedCount,UnknownCount,NeededCount,LastUpdated,LastSyncTime,LastReportedStatusTime | Export-Csv .\ComputerStatus_KB4499175.csv
